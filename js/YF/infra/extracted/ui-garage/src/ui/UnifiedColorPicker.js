 ...
 *
 * This generic, tool-agnostic control intentionally excludes palette,
 * gradient and randomization rules. Drive it with a `swatches` array
 * describing the DOM ids of each row.
 *
    ...
    init() {
        ...
        for (const s of this.swatches) {
            ...
            if (hex && hex.tagName === 'INPUT') {
                this._listen(hex, 'click', (e) => e.stopPropagation());
                this._listen(hex, 'keydown', (e) => e.stopPropagation());
                this._listen(hex, 'blur', () => {
            ...
            this._ownCleanup(this.settings.subscribe?.(s.setting, (value) => {
