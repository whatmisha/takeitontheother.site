...
for (const app of apps) {
    ...
    assert.match(navigation, /aria-label="Back to YF Tools"/u,
...
const cleanupMatrix = await read('infra/docs/LEGACY_CSS_CLEANUP_MATRIX.md');
...
const browserCapture = JSON.parse(await read('infra/baselines/BROWSER_CAPTURE.json'));
