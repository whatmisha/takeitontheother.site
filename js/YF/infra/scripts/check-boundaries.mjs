...
const entrypoints = [
    'index.html',
    'infra/qa/ui-audit/index.html',
    'infra/qa/ui-host/index.html',
    'infra/qa/migrations/index.html',
...
const errors = [];
const runtimeFiles = ['index.html', 'infra/TOOL_CATALOG.json'].map(file => path.join(upgradeRoot, file));
...
function isThirdPartyBundle(relativePath) {
    return relativePath.startsWith('infra/framework/vendor/')
        || relativePath === 'infra/framework/UPSTREAM_V3.json'
