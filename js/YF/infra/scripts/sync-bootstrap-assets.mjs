...
const upgradeRoot = path.dirname(path.dirname(scriptDir));
const checkOnly = process.argv.includes('--check');

const assets = [
    ['keyboarder/vendor/lib/opentype.module.js', 'infra/framework/vendor/opentype/1.3.4/opentype.module.js', 'opentype.js 1.3.4 ESM', 'Framework text-to-path'],
    ['grid_generator/vendor/opentype.min.js', 'infra/framework/vendor/opentype/1.3.4/opentype.min.js', 'opentype.js 1.3.4 UMD', 'Legacy Label text-to-path'],
    ['grid_generator/vendor/licenses/jspdf.txt', 'infra/framework/vendor/licenses/jspdf.txt', 'jsPDF license', 'License'],
    ['grid_generator/vendor/licenses/svg2pdf.js.txt', 'infra/framework/vendor/licenses/svg2pdf.js.txt', 'svg2pdf.js license', 'License'],
    ['grid_generator/vendor/licenses/opentype.js.txt', 'infra/framework/vendor/licenses/opentype.js.txt', 'opentype.js license', 'License']
...
const canonicalAssets = [
    {
        target: 'infra/framework/fonts/CoFoSans-Regular.woff2',
    ...
    {
        target: 'infra/framework/fonts/CoFoSans-Regular.woff',
    ...
    {
        target: 'infra/framework/fonts/CoFoSans-Medium.woff2',
    ...
    {
        target: 'infra/framework/fonts/CoFoSans-Medium.woff',
    ...
    {
        target: 'infra/framework/vendor/jspdf/2.5.1/jspdf.umd.min.js',
    ...
    {
        target: 'infra/framework/vendor/svg2pdf/2.2.3/svg2pdf.umd.min.js',
...
const pinnedDownloads = [
    {
        target: 'infra/framework/vendor/paper/0.12.17/paper-full.min.js',
    ...
    {
        target: 'infra/framework/vendor/paper/0.12.17/LICENSE.txt',
    ...
    {
        target: 'infra/framework/vendor/svg2pdf/2.0.0/svg2pdf.umd.js',
...
const versionsPath = path.join(upgradeRoot, 'infra/framework/vendor/VERSIONS.json');
const versions = {
    schemaVersion: 2,
    generatedBy: 'infra/scripts/sync-bootstrap-assets.mjs',
...
if (checkOnly) {
    ...
    if (actual !== serialized) throw new Error('infra/framework/vendor/VERSIONS.json is stale.');
