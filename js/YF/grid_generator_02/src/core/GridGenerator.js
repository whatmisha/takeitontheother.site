...
import { DraftStore } from '../persistence/DraftStore.js?layout=root-infra-1';
import { DraftRecoveryController } from '../persistence/DraftRecoveryController.js?layout=root-infra-1';
    ...
    constructor() {
        ...
        this.renderScheduler = this.lifecycle.own(new RenderScheduler({
            render: () => {
                ...
                this.packagingPreview?.invalidate();
            },
        ...
        const previewArtwork = new PreviewArtworkBuilder(createExportDocumentPort(this));
        this.packagingPreview = this.lifecycle.own(new PackagingPreviewController({
            getModel: () => ({
                ...this.settingsModule.getAll(),
