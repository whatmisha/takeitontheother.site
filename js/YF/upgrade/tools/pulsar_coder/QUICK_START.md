...
### 2. Используйте минимальный шаблон

Откройте `yf-ui-framework/examples/minimal-template.html` — это готовый стартовый шаблон с базовой функциональностью.
...
- **Примеры всех компонентов:** `examples/example.html`
- **Минимальный шаблон:** `examples/minimal-template.html`
