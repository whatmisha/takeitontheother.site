...
/**
 * Clear SVG group efficiently
 * @param {HTMLElement} group - SVG group element to clear
 */
export function clearGroup(group) {
    // Using innerHTML = '' is faster than removing nodes one by one
    group.innerHTML = '';
}
...
/**
 * Batch append multiple elements to group using DocumentFragment
 * More efficient than appending one by one
 * @param {HTMLElement} group - SVG group element
 * @param {Array<SVGElement>} elements - Array of SVG elements to append
 */
export function batchAppendElements(group, elements) {
