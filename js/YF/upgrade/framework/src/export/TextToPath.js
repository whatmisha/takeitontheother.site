...
export class TextToPath {
    constructor(options = {}) {
        this.fonts = new Map();
        this.fontPaths = {
            'TT Commons Classic-400': new URL('../../fonts/TT Commons Classic Regular.otf', import.meta.url).href,
            'TT Commons Classic-500': new URL('../../fonts/TT Commons Classic Medium.otf', import.meta.url).href,
            'Lunnen Display-400': new URL('../../fonts/LunnenDisplay-VariableVF.ttf', import.meta.url).href,
            ...options.fontPaths
        };
