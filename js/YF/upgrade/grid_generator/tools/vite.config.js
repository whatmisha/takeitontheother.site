...
const frameworkEntryPath = path.resolve(projectRoot, '..', 'infra', 'framework', 'src', 'index.js');
const frameworkRuntimeSpecifier = '../../../infra/framework/src/index.js?v=g6-file-intake-1';
