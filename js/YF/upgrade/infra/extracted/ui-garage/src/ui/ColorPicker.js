...
export class ColorPicker {
    ...
    initEventListeners() {
        if (this.elements.preview) {
            this._listen(this.elements.preview, 'click', () => this.toggle());
        }

        if (this.elements.hexInput) {
            this._listen(this.elements.hexInput, 'input', (e) => {
                this.handleHexInput(e.target.value);
            });
            this._listen(this.elements.hexInput, 'focus', () => {
                this.isHexInputFocused = true;
            });
            this._listen(this.elements.hexInput, 'blur', () => {
        ...
        if (this.elements.hueSlider) {
            this._listen(this.elements.hueSlider, 'input', (e) => {
        ...
        if (this.elements.saturationSlider) {
            this._listen(this.elements.saturationSlider, 'input', (e) => {
        ...
        if (this.elements.brightnessSlider) {
            this._listen(this.elements.brightnessSlider, 'input', (e) => {
