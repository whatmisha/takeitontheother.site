...
test('Chladni PNG uses last rendered threshold and waits for encoding before disposal', async () => {
    ...
    const source = (await read('chladni-sound-pattern/sketch.js')).replaceAll("import('../infra/framework/src/ui/GeneratorHost.js?v=3')", 'Promise.resolve({downloadCanvas:testDownloadCanvas})');
