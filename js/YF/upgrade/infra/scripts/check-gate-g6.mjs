...
const [plan, gate, browser, manifest, lab] = await Promise.all([
    read('infra/docs/G6_INTERFACE_UNIFICATION_PLAN.md'),
    read('infra/docs/GATE_G6.md'),
    read('infra/docs/BROWSER_ACCEPTANCE.md'),
    read('infra/APPLICATION_CAPABILITIES.json'),
    read('infra/framework/component-lab/index.html')
]);
