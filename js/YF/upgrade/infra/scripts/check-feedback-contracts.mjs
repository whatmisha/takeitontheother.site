...
const [
    ...
    read('infra/framework/src/ui/DialogHost.js'),
    read('infra/framework/src/ui/OverlayDialogHost.js'),
    read('infra/framework/src/ui/TooltipService.js'),
    read('infra/framework/src/core/ApplicationShell.js'),
    read('infra/framework/css/othersite-styles.css'),
    read('infra/framework/src/ui/UnifiedUiController.js'),
    read('sparky/tool.js'),
