...
const upgradeRoot = path.dirname(path.dirname(path.dirname(fileURLToPath(import.meta.url))));
const isolatedRoot = path.join(upgradeRoot, 'infra/extracted/ui-garage');
