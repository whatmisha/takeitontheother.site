...
const manifest = JSON.parse(await readFile(absolute('infra/FINAL_LIVE_ACCEPTANCE.json'), 'utf8'));
...
const pizzaHarness = await readFile(absolute('infra/qa/pizza-file-intake.html'), 'utf8');
