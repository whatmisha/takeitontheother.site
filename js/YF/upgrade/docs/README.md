...
Gate G8 пройден: все восемь инструментов используют единый системный UI-стек,
...
- Приёмочные gates: [G1](./GATE_G1.md), [G2](./GATE_G2.md), [G3](./GATE_G3.md), [G4](./GATE_G4.md), [G5](./GATE_G5.md), [G6](./GATE_G6.md), [G7](./GATE_G7.md), [G8](./GATE_G8.md).
- Текущий UI-цикл: [план G8](./G8_UI_CONTRACT_PLAN.md) и [live acceptance](./G8_UI_ACCEPTANCE.md).
