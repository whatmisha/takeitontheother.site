...
class GridGenerator {
    ...
    */
    ...
    async exportSVG() {
        ...
        // Формируем имя файла: "(значение из ячейки B)_laptop_label_120×24mm.svg"
        ...
        const filename = `${sanitizedValue}_laptop_label_${size}.svg`;
    ...
    async generateAllStickers() {
        ...
        try {
            ...
            for (let rowIndex = 0; rowIndex < this.loadedTableData.length; rowIndex++) {
                ...
                // Генерируем имя файла: "(значение из ячейки B)_laptop_label_120×24mm.svg"
                let cellBValue = '';
                if (row && row.length > 1) {
