...
export class ColorUtils {
    ...
    /**
     * Получить контрастный цвет (черный или белый) для заданного фона
    ...
    static getGridOpacity(luminance, baseOpacity) {
        // Ограничиваем светимость для избежания экстремальных значений
        ...
        // Параболическая кривая: максимум при 0.5, минимум на краях
        const factor = 1 - Math.pow(2 * clampedLuminance - 1, 2);
        
        const minOpacity = baseOpacity * 0.3; // 30% от базовой на краях
