...
export class GraphicsRenderer {
    ...
    getGridContext(planeWidth, scale = 1, explicitGridContext = null) {
        ...
        return {
            ...
            planeWidth: planeWidth == null ? this.settings.get('frontWidth') : planeWidth / scale
        };
    }
    ...
    calculateDimensions(block, explicitGridContext = null) {
        ...
        if (block.sizeMode === 'width') {
            ...
            const contentWidth = context.planeWidth - 2 * margins * module;
