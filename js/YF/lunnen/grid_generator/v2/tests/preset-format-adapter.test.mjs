...
test('organized preset JSON round-trips every editable document setting', () => {
        ...
        planes: [
            {
                ...
                grid: { mode: 'inherit', own: {
                        module: 5, margins: 2, columns: 4, rows: 4, rowHeight: 4,
                        marginsUnit: 'mod', lockedModule: false, lockedMargins: false
                    } },
                visible: true
            },
            {
                ...
                contentRotation: 180,
                grid: { mode: 'own', own: {
                        module: 4, margins: 1.5, columns: 6, rows: 9, rowHeight: 3,
                        marginsUnit: 'mod', lockedModule: false, lockedMargins: false
                    } },
                visible: false
            },
            {
                ...
                name: 'Top flap',
                kind: 'flap',
                size: { width: 'fit', height: 'flapDepth' },
                attach: { to: 'front', edge: 'top', align: 'center', offset: 2 },
                contentRotation: 90,
                grid: { mode: 'inherit', own: {
                        module: 5, margins: 2, columns: 4, rows: 4, rowHeight: 4,
                        marginsUnit: 'mod', lockedModule: false, lockedMargins: false
    ...
    assert.deepEqual(normalized.settings.planeDocument, planeDocument);
