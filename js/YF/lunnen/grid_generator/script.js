...
class GridGenerator {
    ...
    drawBaselineVerticalLeftRight(container, x, y, width, height, scale, side) {
        this.gridRenderer.drawBaselineVerticalLeftRight(container, x, y, width, height, scale, side);
    }
    
    drawBaselineTopBottom(container, x, y, width, height, scale, side) {
        this.gridRenderer.drawBaselineTopBottom(container, x, y, width, height, scale, side);
    }
    ...
    exportSettings() {
        ...
        this.svgExporter.exportSettings(`grid-settings_${timestamp}.json`);
    }
}
