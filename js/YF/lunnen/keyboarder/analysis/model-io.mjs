    ...
    contentEdits: {
        '0:main:0': {
            ...
            elements: [{
                ...
                kind: 'txt',
                text: 'QA',
                fontId: 'session:ys-text-bold:123',
                size: '12.3456',
                tracking: '0.02',
                compOverride: { px: '0.5' },
...
const cleanCompTable = sanitizeCompensationTableEdits(edited.compensationTableEdits);
assert.deepEqual(cleanCompTable['~'], { L: 12.35, R: null });
