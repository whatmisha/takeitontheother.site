...
Update 2026-08-02: reference verification is layout-specific. `app/kb/reference-assets.js` maps
Work 2.0 L and the six reference rebuilds to `.layout.json` geometry files and `_curv.svg` visual
