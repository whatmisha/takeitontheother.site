...
слева. `Reset` удаляет overrides выбранных клавиш/активной ширины и возвращает контент или
геометрию из генератора.

Осталось по этапу 4: полное редактирование рядов/клавиш для добавления и удаления клавиш/рядов,
richer JSON-модель для полного кругового цикла и явная edited-keyboard модель поверх текущих
preset override blobs.
