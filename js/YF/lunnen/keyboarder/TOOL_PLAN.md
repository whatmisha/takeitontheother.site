...
`Reference grid` дополнительно чистит осиротевшие `contentEdits` добавленных клавиш.
`Reset` удаляет overrides выбранных клавиш/активной ширины и возвращает контент или геометрию из
генератора.

Осталось по этапу 4: перестановка клавиш, добавление рядов, удаление/восстановление рядов,
