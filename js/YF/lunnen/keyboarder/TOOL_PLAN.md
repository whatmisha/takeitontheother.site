...
Статус: **этапы 0, 1 и 2 сделаны**. Этап 3 частично реализован: есть сверка геометрии
и легенд с эталонными JSON, кнопка Verify и CLI-проверки; полноценный Diff-режим и экспорт
JSON-отчёта ещё впереди.
