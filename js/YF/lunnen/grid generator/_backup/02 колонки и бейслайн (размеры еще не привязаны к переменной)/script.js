class GridGenerator {
    constructor() {
        ...
        this.settings = {
            ...
            // Grid settings
            columnCount: 12,
            columnWidth: 28.778,  // mm
            columnGutter: 3.029,  // mm
            showColumns: true,
            baselineHeight: 2.91,  // mm
            showBaseline: true
        };
    ...
    cacheDOMElements() {
        return {
            ...
            columnWidthSlider: document.getElementById('columnWidth'),
            columnWidthValue: document.getElementById('columnWidthValue'),
            columnGutterSlider: document.getElementById('columnGutter'),
            columnGutterValue: document.getElementById('columnGutterValue'),
            baselineHeightSlider: document.getElementById('baselineHeight'),
            baselineHeightValue: document.getElementById('baselineHeightValue'),
    ...
    initEventListeners() {
        ...
        // Column width slider
        this.dom.columnWidthSlider.addEventListener('input', (e) => {
            const value = parseFloat(e.target.value);
            this.dom.columnWidthValue.value = value.toFixed(3);
            this.settings.columnWidth = value;
            this.updateGrid();
        });
        
        // Column gutter slider
        this.dom.columnGutterSlider.addEventListener('input', (e) => {
            const value = parseFloat(e.target.value);
            this.dom.columnGutterValue.value = value.toFixed(3);
            this.settings.columnGutter = value;
            this.updateGrid();
        });
        
        // Baseline height slider
        this.dom.baselineHeightSlider.addEventListener('input', (e) => {
            const value = parseFloat(e.target.value);
            this.dom.baselineHeightValue.value = value.toFixed(2);
            this.settings.baselineHeight = value;
            this.updateGrid();
        });
    ...
    drawColumns(x, y, width, height, scale) {
        const margin = this.settings.columnGutter * 2 * scale; // margin is 2x gutter
        const columnWidth = this.settings.columnWidth * scale;
        const gutter = this.settings.columnGutter * scale;
    ...
    drawBaseline(x, y, width, height, scale) {
        const margin = this.settings.columnGutter * 2 * scale; // same margin as columns
        const baselineHeight = this.settings.baselineHeight * scale;
