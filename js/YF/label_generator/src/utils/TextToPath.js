...
export class TextToPath {
    constructor() {
        ...
        this.fontPaths = {
            'TT Commons Classic-400': '../infra/framework/fonts/TT Commons Classic Regular.otf',
            'TT Commons Classic-500': '../infra/framework/fonts/TT Commons Classic Medium.otf',
    ...
    async loadOpentype() {
        ...
        this.loadingPromise = new Promise((resolve, reject) => {
            ...
            script.src = '../infra/framework/vendor/opentype/1.3.4/opentype.min.js';
            script.onload = () => {
                this.opentypeLoaded = true;
                resolve(true);
            };
    ...
    async convertTextElementToPath(textElement) {
        try {
            ...
            // Сначала вычисляем общую ширину текста для правильного позиционирования при text-anchor="middle" или "end"
            let totalWidth = 0;
            ...
            // Вычисляем начальную позицию с учетом text-anchor
            let startX = x;
