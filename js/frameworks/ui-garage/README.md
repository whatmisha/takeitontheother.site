...
Read `START_HERE.md` and `PROJECT_LAYOUT.md` before creating an application, and `CONTRACT.md` before
...
With the copied framework at `infra/ui-garage/`, create a non-destructive clean
tool beside the other top-level tools:
