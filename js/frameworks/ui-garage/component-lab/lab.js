...
try {
    ...
    const exportButton = document.getElementById('labExplicitExport');
    exportFeedback = new ExportFeedbackController({
        button: exportButton,
        status: document.getElementById('labExplicitExportStatus')
    });
    exportButton.addEventListener('click', () => {
        exportFeedback.run(() => new Promise(resolve => window.setTimeout(resolve, 350)));
    });
